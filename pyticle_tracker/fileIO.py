...
def init_netcdf(self,outfile):
    ...
    ** Initialize an ncfile in which to save output and save first step.**
    ...
    if os.path.isfile(outfile):
        ...
        ncid.createVariable('x', 'd', ('time','npts'), zlib=self.opt.zlib, \
                    least_significant_digit=self.opt.lsd)
        ncid.createVariable('y', 'd', ('time','npts'), zlib=self.opt.zlib, \
                    least_significant_digit=self.opt.lsd)
        ncid.createVariable('u', 'd', ('time','npts'), zlib=self.opt.zlib, \
                    least_significant_digit=self.opt.lsd)
        ncid.createVariable('v', 'd', ('time','npts'), zlib=self.opt.zlib, \
                    least_significant_digit=self.opt.lsd)
